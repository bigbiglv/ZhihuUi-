...
import CardHeader from '@/components/AnswerCard/components/Header.vue'
import CardTitle from '@/components/AnswerCard/components/Title.vue'
import CardContent from '@/components/AnswerCard/components/Content.vue'
import CardActions from '@/components/AnswerCard/components/Actions.vue'
import CardComments from '@/components/AnswerCard/components/Comments.vue'
...
<template>
  ...
  <article
    v-else
    class="group rounded-2xl bg-card p-6 shadow-xs border border-border-subtle hover:shadow-md transition-all duration-300"
  >
    <!-- 头部：作者信息与时间 -->
