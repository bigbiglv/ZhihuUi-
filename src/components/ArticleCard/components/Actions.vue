...
function handleToggleComments() {
  ...
  if (newStatus && props.data && props.data.id) {
    addSeenId(`${props.data.type || 'article'}-${props.data.id}`)
  ...
  >
    ...
    <div class="flex items-center gap-4 text-muted-foreground">
      ...
      <button
        ...
        :class="isFavorited ? 'text-yellow-500' : 'hover:text-foreground'"
        class="flex items-center space-x-1.5 py-1.5 transition cursor-pointer"
      >
    ...
    <div class="flex items-center gap-4">
      ...
      <button
        ...
        :class="isCommentsExpanded ? 'text-primary' : 'hover:text-foreground'"
        class="flex items-center space-x-1.5 py-1.5 transition cursor-pointer"
      >
